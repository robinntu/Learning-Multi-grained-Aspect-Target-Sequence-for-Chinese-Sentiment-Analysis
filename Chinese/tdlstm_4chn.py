...
x_fw = LSTM(output_dim=32, input_dim=128, return_sequences=True,W_regularizer=l2(0.01), consume_less='mem')(inputs)

x_bw = LSTM(output_dim=32, input_dim=128, return_sequences=True,W_regularizer=l2(0.01), consume_less='mem',go_backwards=True)(inputs)
