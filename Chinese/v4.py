...
lstm1 = LSTM(output_dim=32,activation='relu', return_sequences=True,W_regularizer=l2(0.01), consume_less='mem')(inputs)
...
var0=Convolution1D(150,2,bias=False,border_mode='valid',activation='tanh')(lstm_input1)

var2=tf.contrib.layers.flatten(var0)
