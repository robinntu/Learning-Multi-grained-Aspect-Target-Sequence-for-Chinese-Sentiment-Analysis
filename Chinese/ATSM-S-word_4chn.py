...
def aspect_layer(seq):
    vec=x_batch_dot[:,:,seq]
    #below concatenate the aspect unit lstm output vector to every unit in a sentence
...
print lstm_input1.get_shape()

var0= LSTM(output_dim=256,  input_length=3,activation='relu',return_sequences=False,W_regularizer=l2(0.01), inner_activation='sigmoid')(lstm_input1)
