...
atten_output_w1f = merge([atten_output_w1, atten_output_c1, atten_output_c2,atten_output_r1, atten_output_r2, atten_output_r3,atten_output_r4,atten_output_r5,atten_output_r6],  mode= 'concat')
atten_output_w2f =merge([atten_output_w2, atten_output_c3, atten_output_c4,atten_output_r7, atten_output_r8, atten_output_r9,atten_output_r10,atten_output_r11,atten_output_r12],  mode= 'concat')
atten_output_w3f = merge([atten_output_w3, atten_output_c5, atten_output_c6,atten_output_r13, atten_output_r14, atten_output_r15,atten_output_r16,atten_output_r17,atten_output_r18],  mode= 'concat')
...
with tf.Session() as sess:
    ...
    dataset_w=pickle.load(open('..data/Chinese/word/2556embedding.py','r'))
    ...
    # load aspect info
    aspect_mat_w=pickle.load(open('..data/Chinese/word/2556id.py','r'))
